		...
		<div class="modal1 mfp-hide subscribe-widget mx-auto" id="myModal1" style="max-width: 750px;">
			<div class="row justify-content-center bg-white align-items-center" style="min-height: 380px;">
				<div class="col-md-5 p-0">
					<div style="background: url('{{ asset('assests/site/images/modal1.jpg') }}') no-repeat center right; background-size: cover;  min-height: 380px;"></div>
				</div>
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					...
					<div class="swiper-slide dark">
						...
						<div class="swiper-slide-bg" style="background-image: url('{{ asset('assests/site/images/slider/3.jpg') }}'); background-position: center 20%;"></div>
					</div>
					<div class="swiper-slide dark">
						<div class="container">
							<div class="slider-caption slider-caption-center">
						...
						<div class="swiper-slide-bg" style="background-image: url('{{ asset('assests/site/images/slider/2.jpg') }}'); background-position: center 40%;"></div>
					</div>
				</div>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div class="row shop-categories clearfix">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{ asset('assests/site/images/categories/4.jpg') }}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{ asset('assests/site/images/categories/3.jpg') }}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
						...
						<div class="col-lg-4">
							<a href="#" style="background: url('{{ asset('assests/site/images/categories/5.jpg') }}') no-repeat center center; background-size: cover;">
								<div class="vertical-middle dark center">
									<div class="heading-block m-0 border-0">
					...
					<div id="oc-products" class="owl-carousel products-carousel carousel-widget" data-margin="20" data-loop="true" data-autoplay="5000" data-nav="true" data-pagi="false" data-items-xs="1" data-items-sm="2" data-items-md="3" data-items-lg="4" data-items-xl="5">
						...
						<div class="oc-item">
							<div class="product">
								<div class="product-image">
									<a href="#"><img src="{{ asset('assests/site/images/items/featured/5.jpg') }}" alt="Shoes"></a>
									<a href="#"><img src="{{ asset('assests/site/images/items/featured/5-1.jpg') }}" alt="Shoes"></a>
									<div class="bg-overlay">
